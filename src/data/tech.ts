...
export const TECHS: TechDef[] = [
  ...
  {
    id: 'tech_clone_slot_1',
    category: 'copias',
    name: 'Segunda Camara',
    description: 'Permite manter mais uma copia ativa ao mesmo tempo.',
    cost: { iron: 70, crystal: 8 },
    requires: ['tech_cloner'],
    requiredDepth: 120,
    modifiers: [{ target: 'cloneSlots', op: 'flat', value: 1 }],
    icon: '⧉',
    position: { x: 1, y: 1 },
  },
  {
    id: 'tech_clone_slot_2',
    category: 'copias',
    name: 'Terceira Camara',
    description: 'Mais uma camara de impressao.',
    cost: { iron: 160, gold: 30, crystal: 18 },
    requires: ['tech_clone_slot_1'],
    requiredDepth: 320,
    modifiers: [{ target: 'cloneSlots', op: 'flat', value: 1 }],
    icon: '⧉',
    position: { x: 2, y: 1 },
